...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"com.woniper.spring"}, excludeFilters=@ComponentScan.Filter(Configuration.class))
public class WebAppConfiguration extends WebMvcConfigurerAdapter {
    ...
    public ContentNegotiatingViewResolver viewResolver() {
    	...
    	resolver.setOrder(1);
    	ContentNegotiationManager cnm = new ContentNegotiationManager(new PathExtensionContentNegotiationStrategy(getMediaType()));
